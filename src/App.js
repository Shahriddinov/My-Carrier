...
import DowloadShare from "./components/DowloadShare";

const enhancer = connect(
  ({ resumes: { doneResumes } }) => ({ doneResumes }),
  null
);
    ...
    <div className="app-wrapper">
      ...
      <Routes>
        <Route
          ...
          element={<Home addedTopMargin={addedTopMargin} />}
        />
        ...
        <Route path={RoutesPath.downloadAndShare} element={<DowloadShare />} />
