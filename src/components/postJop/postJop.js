        ...
        <div className="main_jop h-100">
            <div className="container">
                ...
                <div className="row komputer">
                    <div className="col-6">
                        <Link onClick={() => {
                            dispatch(displayCircle(false))
                        }} to={RoutesPath.postJop1} className="text-black card_jop">
                            <div className="d-flex align-items-center">
                                <div className="me-3"><img className="w-100" src="/images/clock.png" alt=""/></div>
                                <h6 className="mt-1">Hourly payed job</h6>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut et ex iusto magni numquam
                                quaerat.</p>
                        </Link>
                        <Link to={RoutesPath.postJop1} className="card_jop1 text-black">
                            <div className="d-flex align-items-center">
