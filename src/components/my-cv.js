        ...
        <div className="cv-box">
          <div className="box-for-resume">
            <div
              className={
                props.resume
                  ? "card-resume resume-show"
                  : "card-resume resume-hide"
              }
            >
              {props.resumeNumbers === "first" ? (
                <div ref={componentRef} className="card-resume">
                  {" "}
                  <FirstTemplateResume />{" "}
                </div>
              ) : (
